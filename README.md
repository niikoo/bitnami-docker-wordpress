...
* [`5-debian-10`, `5.5.0-debian-10-r1`, `5`, `5.5.0`, `latest` (5/debian-10/Dockerfile)](https://github.com/bitnami/bitnami-docker-wordpress/blob/5.5.0-debian-10-r1/5/debian-10/Dockerfile)
...
$ docker run -d --name wordpress \
  -p 8080:8080 -p 8443:8443 -p 9001:9001 \
  --env ALLOW_EMPTY_PASSWORD=yes \
